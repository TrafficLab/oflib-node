        ...
        "match" : function match_unpack(buffer, offset) {
                ...
                switch (type) {
                    ...
                    case ofp.ofp_match_type.OFPMT_STANDARD: {
                        ...
                        if (match.dl_src_mask == '00:00:00:00:00:00') {
                            match.dl_src_mask = undefined;
                        }

                        if (match.dl_src_mask == 'ff:ff:ff:ff:ff:ff') {
                            match.dl_src = undefined;
                            match.dl_src_mask = undefined;
                        }
                        ...
                        if (match.dl_dst_mask == '00:00:00:00:00:00') {
                            match.dl_dst_mask = undefined;
                        }

                        if (match.dl_dst_mask == 'ff:ff:ff:ff:ff:ff') {
                            match.dl_dst = undefined;
                            match.dl_dst_mask = undefined;
                        }
                        ...
                        if (match.nw_src_mask == '0.0.0.0') {
                            match.nw_src_mask = undefined;
                        }

                        if (match.nw_src_mask == '255.255.255.255') {
                            match.nw_src = undefined;
                            match.nw_src_mask = undefined;
                        }
                        ...
                        if (match.nw_dst_mask == '0.0.0.0') {
                            match.nw_dst_mask = undefined;
                        }

                        if (match.nw_dst_mask == '255.255.255.255') {
                            match.nw_dst = undefined;
                            match.nw_dst_mask = undefined;
                        }
                        ...
                        if (match.metadata_mask == '0000000000000000') {
                            match.metadata_mask = undefined;
                        }

                        if (match.metadata_mask == 'ffffffffffffffff') {
