            ...
            case ofp.ofp_type.OFPT_STATS_REQUEST: {
                ...
                switch (statType) {
                    ...
                    case ofp.ofp_stats_types.OFPST_FLOW: {
                        ...
                        message.body.body.cookie = buffer.toString('hex', offset, offset + 8);
                        message.body.body.cookie_mask = buffer.toString('hex', offset + 8, offset + 16);
                        offset += 16;
            ...
            case ofp.ofp_type.OFPT_STATS_REPLY: {
                ...
                switch (statType) {
                    ...
                    case ofp.ofp_stats_types.OFPST_AGGREGATE: {
                        ...
                        message.body.body.packet_count = {"high" : buffer.readUInt32BE(offset, true),
                                                          "low" : buffer.readUInt32BE(offset + 4, true)};
                        offset += 8;

                        message.body.body.byte_count = {"high" : buffer.readUInt32BE(offset, true),
                                                        "low" : buffer.readUInt32BE(offset + 4, true)};
                        offset += 8;
